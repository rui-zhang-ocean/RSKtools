...
* And lots of other stuff like automatic cast detection and bin
  averaging.  Read the Matlab help (by typing `help RSKtools`) once
  you've installed it, or check out the introductory and
  post-processing vignettes in the `vignette` directory.
...
`RSKderivesalinity` to calculate Practical Salinity for RSK objects.
